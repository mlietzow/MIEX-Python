...
class test_miex(unittest.TestCase):
    ...
    def test_bh(self):
        ...
        self.assertAlmostEqual(
            result[0], 3.10543, msg='incorrect Q_ext', delta=0.00001)
        self.assertAlmostEqual(
            result[1], 0.00000, msg='incorrect Q_abs', delta=0.00001)
        self.assertAlmostEqual(
            result[2], 3.10543, msg='incorrect Q_sca', delta=0.00001)
        self.assertAlmostEqual(
            result[3], 2.92534, msg='incorrect Q_bk', delta=0.00001)

        S_11, S_12, S_33, S_34 = miex.scattering_matrix_elements(
            result[7], result[8])
        S_12 /= -S_11
        S_33 /= S_11
        S_34 /= S_11
        ...
        bh_S_12 = np.array([
            0.000000e+00, -0.459811e-02, -0.458541e-01, -0.364744e+00, -
            0.534997e+00, 0.959953e-02, 0.477927e-01, -
            0.440604e+00, -0.831996e+00, 0.341670e-01,
            0.230462e+00, -0.713472e+00, -0.756255e+00, -0.281215e+00, -0.239612e+00, -
            0.850804e+00, -0.706334e+00, -0.891081e+00, -0.783319e+00, -0.196194e+00,
            0.000000e+00
        ])
        bh_S_33 = np.array([
            ...
            0.937497e+00, -0.717397e-02, -
            0.394748e-01, 0.536251e+00, 0.967602e+00, 0.187531e+00, 0.495254e+00, 0.453277e+00, -
            0.391613e+00, -0.962069e+00,
            -0.100000e+01
        ])
        bh_S_34 = np.array([
            0.000000e+00, 0.343261e-01, 0.160184e+00, 0.394076e+00, -0.491787e+00, -
            0.280434e+00, 0.163584e+00, 0.621216e+00, -0.516208e+00, -0.605182e+00,
            0.260742e+00, 0.700647e+00, -0.653085e+00, -0.795835e+00, 0.795798e-01, -
            0.490882e+00, -0.505781e+00, -0.226817e-01, 0.482752e+00, 0.189556e+00,
            0.000000e+00
        ])
    ...
    def test_w_1(self):
        ...
        S_11, S_12, _, _ = miex.scattering_matrix_elements(
            result[7], result[8])
        S_12 /= S_11
        ...
        w_S_12 = np.array([
            0.0000, -0.0239, -0.0963, -0.2080, -
            0.2887, 0.4685, 0.0005, -0.0892, -0.0767, 0.7251,
            0.4834, -0.0592, -0.0163, 0.9793, 0.3242, -
            0.3951, 0.5014, 0.9514, -0.0269, 0.1127,
    ...
    def test_w_2(self):
        ...
        w_S_12 = np.array([
            0.0000, -0.0107, 0.0098, 0.0712, -0.0248, -
            0.0730, -0.0540, 0.2001, 0.0919, -0.1301,
            0.4545, 0.1026, 0.4679, -0.2130, 0.7357, -
            0.0054, 0.8365, -0.2535, -0.0016, -0.4214,
            -0.5649, -0.3412, 0.3830, -0.0700, -
            0.8726, 0.1822, 0.5235, 0.4015, 0.3292, 0.0578,
    ...
    def test_w_3(self):
        ...
        w_S_12 = np.array([
            ...
            0.5051, 0.1317, -0.0010, -0.1018, -
            0.0523, 0.3454, -0.0192, -0.3916, 0.0127, -0.8087,
            -0.8588, -0.6411, -0.6625, -0.5131, 0.3474, -
            0.4821, -0.2850, -0.2910, 0.3604, -0.3089,
    ...
    def test_w_4(self):
        ...
        w_S_12 = np.array([
            ...
            0.5594, 0.3873, 0.0148, 0.8293, 0.0368, 0.0580, -
            0.1909, -0.3772, -0.4089, -0.7399,
            -0.7719, -0.6412, 0.9228, -0.8142, -
            0.1234, 0.0435, -0.3815, -0.1249, -0.1602, -0.6980,
    ...
    def test_w_5(self):
        ...
        w_S_12 = np.array([
            0.0000, -0.0014, -0.0068, -0.0301, -0.6183, -
            0.2518, -0.2817, -0.7359, -0.6378, -0.5132,
            -0.9235, -0.7194, -0.6077, -0.1744, -0.2426, -
            0.7454, -0.6373, 0.3019, -0.0893, -0.8614,
            -0.6653, 0.2706, 0.0790, -0.7132, -
            0.8966, 0.1033, 0.3819, -0.0370, -0.6271, 0.0599,
    ...
    def test_w_6(self):
        ...
        w_S_12 = np.array([
            0.0000, -0.0247, -0.0848, -0.2375, -0.4798, -
            0.5484, -0.5537, -0.6268, -0.7490, -0.8418,
            -0.8905, -0.9395, -0.9797, -0.9960, -0.9944, -
            0.9750, -0.9395, -0.8885, -0.8273, -0.7576,
            -0.6831, -0.6072, -0.5316, -0.4586, -0.3897, -
            0.3257, -0.2673, -0.2148, -0.1684, -0.1278,
    ...
    def test_w_7(self):
        ...
        w_S_12 = np.array([
            0.0000, -0.0682, -0.1681, -0.2830, -0.3931, -
            0.4861, -0.5789, -0.6682, -0.7517, -0.8267,
            -0.8909, -0.9417, -0.9765, -0.9939, -0.9928, -
            0.9737, -0.9379, -0.8878, -0.8265, -0.7571,
            -0.6829, -0.6069, -0.5315, -0.4586, -0.3897, -
            0.3258, -0.2674, -0.2149, -0.1684, -0.1279,
            -0.0932, -0.0643, -0.0409, -0.0229, -0.0101, -0.0025, 0.0000
        ])
    ...
    def test_w_8(self):
        ...
        w_S_12 = np.array([
            0.0000, -0.1103, -0.1975, -0.2927, -0.3902, -
            0.4856, -0.5788, -0.6680, -0.7513, -0.8264,
            -0.8906, -0.9414, -0.9763, -0.9936, -0.9926, -
            0.9735, -0.9378, -0.8878, -0.8264, -0.7570,
            -0.6829, -0.6069, -0.5315, -0.4586, -0.3897, -
            0.3258, -0.2674, -0.2149, -0.1684, -0.1279,
            -0.0932, -0.0643, -0.0409, -0.0229, -0.0101, -0.0025, 0.0000
        ])
